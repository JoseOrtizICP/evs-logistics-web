...
ALTER TABLE guias ADD COLUMN IF NOT EXISTS descripcion TEXT;
ALTER TABLE guias ADD COLUMN IF NOT EXISTS cantidad NUMERIC;
ALTER TABLE guias ADD COLUMN IF NOT EXISTS unidad TEXT;
ALTER TABLE guias ADD COLUMN IF NOT EXISTS peso_kg NUMERIC;
ALTER TABLE guias ADD COLUMN IF NOT EXISTS volumen_cbm NUMERIC;
ALTER TABLE guias ADD COLUMN IF NOT EXISTS bultos NUMERIC;
`
